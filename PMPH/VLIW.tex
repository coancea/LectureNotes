...
\begin{block}{TAC Optim Code{\tt~~~~~~~~~~~}MIPS Optim Code}\vspace{-2ex}
\begin{columns}
...
\begin{frame}[fragile,t]
    \frametitle{Loop Unrolling on A Super-Pipeline}

The \# clocks taken by each instr shown in parenthesis,
assuming a 5-stage floating-point execution pipeline.  
...
{\bf Drawbacks of Loop Unrolling:}\pause
\begin{itemize}
...
\begin{itemize}
    \item Initiation Interval = 1 resolves all dependencies, according to schedule: 
        \begin{itemize}
            \begin{scriptsize}
            \item the STORE of each VLIW instr is 5 instrs (iters) behind the ADD,
