...
int main() {
    ...
    { // Compute transformed program in which all read and write 
      ...
      // ToDo: fill in the implementation CPU orchestration code
      //       below and the corresponding CUDA kernel!

        // 1. Probably you would like to allocate some extra CUDA
        //    buffers here.
        ...
        for (int kkk = 0; kkk < REPEAT; kkk++) {
            // 2.1  you probably want to transpose A here by using
            //      function "transposeTiled<float, TILE>"
            // 2.2  you probably want to implement the "transfProg"
            //      kernel in file transpose-kernel.cu.h and to 
            //      call it here.
            // 2.3  you probably want to transpose-back the result here
        }
        cudaThreadSynchronize();
        ...
        // 3. You probably want to deallocate the extra CUDA buffers here.
   }
