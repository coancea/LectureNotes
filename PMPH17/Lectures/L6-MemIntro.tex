...
\input{Struct_Interm/StructMemHier.tex}
...
\hspace{-4ex}\includegraphics[width=40ex]{Figures/FigsMemH/WriteThrough}\pause
...
{\tt BusRd$_1$,BusUpgr$_1$ (pattern detected =>) BusRdX$_2$,BusRdX$_3$,...}
\end{scriptsize}
\end{columns}
\end{block}
